...
for dataset in dataset_list:
    ...
    for iter in range(args.subset_train_iter):
        # Load the model
        net, criterion, optimizer, scheduler = load_model_and_train_params(args.image_size, device, args.lr, testset, args.use_old, cut_out = True)
    ...
    for iteration in range(args.iterations):
        for trial in range(args.trials):
            ...
            for approach in args.approach_list:
                ...
                net, criterion, optimizer, scheduler = load_current_model_and_train_params(net, args.lr, args.use_old, cut_out = True)

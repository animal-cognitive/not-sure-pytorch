        ...
        if fp_total:
            ...
            for c_hat in list_c:
                ...
                if len(images_from_c_hat) > 0 and len(images_from_c_hat) == len(images_from_c):
                    ...
                    mix(cam, images_from_c, second_version_of_images_from_c, args.image_size, dataset, 0.0, 0.5, args.approach_list, sure_or_not_sure_folder = folder_to_save_imgs)
    ...
    for iteration in range(args.iterations):
        for trial in range(args.trials):
            ...
            for approach in args.approach_list:
                ...
                run_experiment_mixup_approach(trainloader, testloader, current_exp, args.epochs, net, optimizer, scheduler, best_acc, criterion, device, args.lr)

...
trials = 1 #2 # type=int, help='Number of times to run the complete experiment')
iterations = 2#4 # type=int, help='Number of times to run the complete experiment')
epochs = 3 # 200 # type=int, help='Epochs')
...
ns_epochs = 3 #200 # type=int, help='ns_epochs')

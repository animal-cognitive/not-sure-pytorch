    ...
    for iteration in range(args.iterations):
        for trial in range(args.trials):
            ...
            for approach in args.approach_list:
                ...
                run_experiment_cutmix_approach(trainloader, testloader, current_exp, args.epochs, net, optimizer, scheduler, best_acc, criterion, device, args.lr, args.beta, args.cutmix_prob)

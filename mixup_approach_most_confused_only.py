...
for dataset in dataset_list:
    ...
    for iteration in range(args.iterations):
        for trial in range(args.trials):
            ...
            _, metrics = run_experiment_mixup_approach_on_most_confused_only(trainloader, testloader, current_exp, args.epochs, net, optimizer, scheduler, best_acc, criterion, device, args.lr,
